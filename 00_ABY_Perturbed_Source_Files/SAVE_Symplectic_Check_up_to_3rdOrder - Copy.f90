SUBROUTINE  SAVE_Symplectic_Check_up_to_3rdOrder(G0)
    Use INTEGRATION
    USE problem_data
...
IMPLICIT NONE
    ...
    integer                  :: j1, j2, J3
      ...
      JJ(6,3) =-1.0D0
       ...
       !CALL OUT_MATRIX( SYMPLECTIC_STM_1ST, Symplectic_1st_order_STM, NV, NV, NV, 'Symplectic_1st_order_STM')
       ...
       !   CALL OUT_MATRIX( SYMPLECTIC_STM_2ND, Symplectic_2nd_order_STM(:,:,i), NV, NV, NV, 'Symplectic_2nd_order_STM')
       !end do
       END IF
       ...
       !         CALL OUT_MATRIX( SYMPLECTIC_STM_3RD, Symplectic_3rd_order_STM(:,:,j,i), NV, NV, NV, 'Symplectic_3rd_order_STM')
       !   end do
       !end do 
       end if  
       ...
       !do i=1, NV
        ...
        !        CALL OUT_MATRIX( SYMPLECTIC_STM_3RD, Symplectic_4th_order_STM(:,:,k,j,i), NV, NV, NV, 'Symplectic_4th_order_STM')
        !     end do 
        !  end do
       !end do
    end if  
    ...
    DO I = 1, NV
        DO J = 1, NV
            WRITE(SAVE_SYMPLECTIC_STM_1ST, *) Symplectic_1st_order_STM(J, I)  ! PRINT phi 1st order AS TIME X VEC(PHI)' ~ 300 x (1:..:36)
            DO J1 = 1, NV
                WRITE(SAVE_SYMPLECTIC_STM_2ND, *) Symplectic_2nd_order_STM(J1, J, I)  ! PRINT phi 2nd order AS TIME X VEC(PHI)' ~ 300 x (1:..:36)
                DO J2 = 1, NV
                    WRITE(SAVE_SYMPLECTIC_STM_3RD, *) Symplectic_3rd_order_STM(J2, J1, J, I)  ! PRINT phi 3RD order AS TIME X VEC(PHI)' ~ 300 x (1:..:36)
                    DO J3= 1, NV
                        WRITE(SAVE_SYMPLECTIC_STM_4TH, *) Symplectic_4TH_order_STM(J3, J2, J1, J, I)  ! PRINT phi 3RD order AS TIME X VEC(PHI)' ~ 300 x (1:..:36) 
                    END DO ! J3
                END DO !J2
            END DO !J1                
        END DO  ! J
